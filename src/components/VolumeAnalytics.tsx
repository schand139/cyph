    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          const response = await fetch(`/api/getVolumeData?period=${selectedPeriod}&year=2025&wallet=0xcCCd218A58B53C67fC17D8C87Cb90d83614e35fD`);
          ...
          if (response.ok) {
            ...
            console.log('API data source:', data.source);
            ...
            if (data && data[selectedPeriod] && Array.isArray(data[selectedPeriod])) {
              ...
              console.error('Expected data.' + selectedPeriod + ' to be an array');
            }
          } else {
          ...
          console.error('API request error, falling back to mock data:', apiError);
        }
      ...
      <div className="mt-6">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">
          ...
          <span className="ml-2 text-sm font-normal text-gray-500 dark:text-gray-400">
            (Source: {dataSource === 'blockchain' ? 'Blockchain' : 'Mock Data'})
          </span>
        </h3>
